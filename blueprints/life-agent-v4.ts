// life-agent-v4.ts — Parameter-evolved from v3: Efficiency + beauty are anti-coupled; the Harvester sacrifices both rhythm and c
...
const genomes: EntityGenome[] = [
  ...
  {
    moveSpeed: 0.6, turnBias: 0.0, resourceAttraction: 0.95, trailAttraction: -0.4,
    harvestThreshold: 0.08, energyConserve: 0.7, explorationDrive: 0.4,
    trailIntensity: 0.3, trailColor: 0, pulseFrequency: 0.15, patternSymmetry: 0.2,
  },
  ...
  {
    moveSpeed: 0.35, turnBias: -0.15, resourceAttraction: 0.95, trailAttraction: 0.05,
    harvestThreshold: 0.08, energyConserve: 0.9, explorationDrive: 0.15,
    trailIntensity: 0.5, trailColor: 1, pulseFrequency: 0.1, patternSymmetry: 0.4,
  },
  ...
  // INSIGHT: merge efficiency with beauty. Moderate threshold, high trail intensity.
  {
    ...
    harvestThreshold: 0.12, energyConserve: 0.65, explorationDrive: 0.3,
  ...
  {
    moveSpeed: 0.6, turnBias: 0.05, resourceAttraction: 0.65, trailAttraction: 0.1,
    harvestThreshold: 0.15, energyConserve: 0.7, explorationDrive: 0.3,
    trailIntensity: 0.5, trailColor: 3, pulseFrequency: 0.2, patternSymmetry: 0.5,
  },
  ...
  // INSIGHT: reduced energy waste (lower moveSpeed for endurance) while maintaining resource drive
  {
    ...
    harvestThreshold: 0.1, energyConserve: 0.75, explorationDrive: 0.4,
    trailIntensity: 0.15, trailColor: 4, pulseFrequency: 0.15, patternSymmetry: 0.1,
  },
