// life-agent-v4.ts — Parameter-evolved from v3: Efficiency improves when entities spend energy to find resources rather than hoa
...
const genomes: EntityGenome[] = [
  ...
  // INSIGHT: reduced harvestThreshold from 0.1 to 0.05 to capture more marginal resources
  {
    ...
    harvestThreshold: 0.05, energyConserve: 0.7, explorationDrive: 0.15,
  ...
  // INSIGHT: merge efficiency with beauty. Moderate threshold, high trail intensity.
  {
    ...
    trailIntensity: 0.9, trailColor: 2, pulseFrequency: 0.45, patternSymmetry: 0.75,
  },
  ...
  // INSIGHT: shifted from 0.2 to 0.15 harvestThreshold for better efficiency baseline
  {
    ...
    harvestThreshold: 0.15, energyConserve: 0.45, explorationDrive: 0.5,
    trailIntensity: 0.5, trailColor: 3, pulseFrequency: 0.35, patternSymmetry: 0.5,
  },
  ...
  // INSIGHT: reduced energy waste (lower moveSpeed for endurance) while maintaining resource drive
  {
    ...
    harvestThreshold: 0.1, energyConserve: 0.55, explorationDrive: 0.8,
