// life-agent-v4.ts — Parameter-evolved from v3: Survival is free energy waste. Energy conservation beats speed.
...
const genomes: EntityGenome[] = [
  ...
  // INSIGHT: new role focused purely on efficiency. Low threshold + high attraction.
  {
    ...
    harvestThreshold: 0.08, energyConserve: 0.65, explorationDrive: 0.5,
  ...
  // INSIGHT: reduced harvestThreshold from 0.1 to 0.05 to capture more marginal resources
  {
    ...
    harvestThreshold: 0.05, energyConserve: 0.8, explorationDrive: 0.25,
  ...
  // INSIGHT: shifted from 0.2 to 0.15 harvestThreshold for better efficiency baseline
  {
    ...
    harvestThreshold: 0.15, energyConserve: 0.75, explorationDrive: 0.5,
  ...
  // INSIGHT: reduced energy waste (lower moveSpeed for endurance) while maintaining resource drive
  {
    ...
    harvestThreshold: 0.1, energyConserve: 0.8, explorationDrive: 0.6,
    trailIntensity: 0.15, trailColor: 4, pulseFrequency: 0.2, patternSymmetry: 0.1,
  },
