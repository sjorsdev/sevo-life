// life-agent-v4.ts — Parameter-evolved from v3: Efficiency fails because entities explore and move too much relative to harvest 
...
const genomes: EntityGenome[] = [
  ...
  {
    moveSpeed: 0.55, turnBias: 0.0, resourceAttraction: 0.95, trailAttraction: -0.4,
    harvestThreshold: 0.08, energyConserve: 0.6, explorationDrive: 0.45,
  ...
  // INSIGHT: reduced harvestThreshold from 0.1 to 0.05 to capture more marginal resources
  {
    ...
    trailIntensity: 0.25, trailColor: 1, pulseFrequency: 0.12, patternSymmetry: 0.4,
  },
  ...
  // INSIGHT: merge efficiency with beauty. Moderate threshold, high trail intensity.
  {
    ...
    harvestThreshold: 0.12, energyConserve: 0.65, explorationDrive: 0.55,
    trailIntensity: 0.65, trailColor: 2, pulseFrequency: 0.22, patternSymmetry: 0.75,
  },
  ...
  // INSIGHT: shifted from 0.2 to 0.15 harvestThreshold for better efficiency baseline
  {
    ...
    harvestThreshold: 0.15, energyConserve: 0.65, explorationDrive: 0.35,
    trailIntensity: 0.5, trailColor: 3, pulseFrequency: 0.25, patternSymmetry: 0.5,
  },
  ...
  // INSIGHT: reduced energy waste (lower moveSpeed for endurance) while maintaining resource drive
  {
    ...
    harvestThreshold: 0.1, energyConserve: 0.65, explorationDrive: 0.5,
