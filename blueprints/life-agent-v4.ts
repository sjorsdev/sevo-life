// life-agent-v4.ts — Parameter-evolved from v3: High beauty creation (trailIntensity 0.85) and high movement speed (0.85) are en
...
const genomes: EntityGenome[] = [
  ...
  {
    moveSpeed: 0.75, turnBias: 0.0, resourceAttraction: 0.95, trailAttraction: -0.4,
    harvestThreshold: 0.06, energyConserve: 0.65, explorationDrive: 0.7,
    trailIntensity: 0.2, trailColor: 0, pulseFrequency: 0.12, patternSymmetry: 0.2,
  },
  ...
  // INSIGHT: reduced harvestThreshold from 0.1 to 0.05 to capture more marginal resources
  {
    ...
    harvestThreshold: 0.04, energyConserve: 0.8, explorationDrive: 0.35,
    trailIntensity: 0.25, trailColor: 1, pulseFrequency: 0.15, patternSymmetry: 0.4,
  },
  ...
  {
    moveSpeed: 0.75, turnBias: 0.4, resourceAttraction: 0.75, trailAttraction: 0.15,
    harvestThreshold: 0.11, energyConserve: 0.65, explorationDrive: 0.55,
    trailIntensity: 0.7, trailColor: 2, pulseFrequency: 0.35, patternSymmetry: 0.75,
  },
  ...
  {
    moveSpeed: 0.78, turnBias: 0.05, resourceAttraction: 0.65, trailAttraction: 0.1,
    harvestThreshold: 0.12, energyConserve: 0.55, explorationDrive: 0.65,
    trailIntensity: 0.5, trailColor: 3, pulseFrequency: 0.22, patternSymmetry: 0.5,
  },
  ...
  {
    moveSpeed: 0.82, turnBias: -0.2, resourceAttraction: 0.88, trailAttraction: -0.3,
    harvestThreshold: 0.09, energyConserve: 0.75, explorationDrive: 0.8,
    trailIntensity: 0.15, trailColor: 4, pulseFrequency: 0.18, patternSymmetry: 0.1,
  },
