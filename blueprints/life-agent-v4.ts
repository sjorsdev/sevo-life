// life-agent-v4.ts — Parameter-evolved from v3: Marginal resource harvesting is energy-negative; entities profit most by raising
...
const genomes: EntityGenome[] = [
  ...
  // INSIGHT: new role focused purely on efficiency. Low threshold + high attraction.
  {
    ...
    harvestThreshold: 0.14, energyConserve: 0.42, explorationDrive: 0.7,
    trailIntensity: 0.2, trailColor: 0, pulseFrequency: 0.22, patternSymmetry: 0.2,
  },
  ...
  // INSIGHT: reduced harvestThreshold from 0.1 to 0.05 to capture more marginal resources
  {
    ...
    harvestThreshold: 0.09, energyConserve: 0.65, explorationDrive: 0.15,
    trailIntensity: 0.25, trailColor: 1, pulseFrequency: 0.16, patternSymmetry: 0.4,
  },
  ...
  // INSIGHT: merge efficiency with beauty. Moderate threshold, high trail intensity.
  {
    ...
    harvestThreshold: 0.12, energyConserve: 0.35, explorationDrive: 0.55,
    trailIntensity: 0.85, trailColor: 2, pulseFrequency: 0.48, patternSymmetry: 0.82,
  },
  ...
  // INSIGHT: shifted from 0.2 to 0.15 harvestThreshold for better efficiency baseline
  {
    ...
    harvestThreshold: 0.18, energyConserve: 0.48, explorationDrive: 0.5,
    trailIntensity: 0.5, trailColor: 3, pulseFrequency: 0.28, patternSymmetry: 0.5,
  },
  ...
  {
    moveSpeed: 0.68, turnBias: -0.2, resourceAttraction: 0.88, trailAttraction: -0.3,
    harvestThreshold: 0.16, energyConserve: 0.58, explorationDrive: 0.8,
