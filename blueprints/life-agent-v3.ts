// life-agent-v3.ts — Parameter-evolved from v2: Efficiency bottleneck: entities hoard energy rather than spend it on productive 
...
const genomes: EntityGenome[] = [
  ...
  // INSIGHT: new role focused purely on efficiency. Low threshold + high attraction.
  {
    ...
    harvestThreshold: 0.08, energyConserve: 0.25, explorationDrive: 0.7,
    trailIntensity: 0.2, trailColor: 0, pulseFrequency: 0.1, patternSymmetry: 0.2,
  },
  ...
  // INSIGHT: reduced harvestThreshold from 0.1 to 0.05 to capture more marginal resources
  {
    ...
    harvestThreshold: 0.05, energyConserve: 0.6, explorationDrive: 0.15,
    trailIntensity: 0.25, trailColor: 1, pulseFrequency: 0.08, patternSymmetry: 0.4,
  },
  ...
  // INSIGHT: shifted from 0.2 to 0.15 harvestThreshold for better efficiency baseline
  {
    ...
    harvestThreshold: 0.15, energyConserve: 0.4, explorationDrive: 0.5,
    trailIntensity: 0.5, trailColor: 3, pulseFrequency: 0.18, patternSymmetry: 0.5,
  },
  ...
  // INSIGHT: reduced energy waste (lower moveSpeed for endurance) while maintaining resource drive
  {
    ...
    harvestThreshold: 0.1, energyConserve: 0.5, explorationDrive: 0.8,
