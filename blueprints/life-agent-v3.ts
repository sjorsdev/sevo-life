// life-agent-v3.ts — Parameter-evolved from v2: Movement overhead kills efficiency. Shift from speed-based resource competition 
...
const genomes: EntityGenome[] = [
  ...
  {
    moveSpeed: 0.65, turnBias: 0.4, resourceAttraction: 0.75, trailAttraction: 0.15,
  ...
  {
    moveSpeed: 0.65, turnBias: 0.1, resourceAttraction: 0.92, trailAttraction: 0.2,
    harvestThreshold: 0.06, energyConserve: 0.75, explorationDrive: 0.2,
