// life-agent-v3.ts — Parameter-evolved from v2: Efficiency gains are multiplicative on survival — surviving longer with lower en
...
const genomes: EntityGenome[] = [
  ...
  // INSIGHT: new role focused purely on efficiency. Low threshold + high attraction.
  {
    ...
    harvestThreshold: 0.08, energyConserve: 0.65, explorationDrive: 0.35,
  ...
  // INSIGHT: reduced harvestThreshold from 0.1 to 0.05 to capture more marginal resources
  {
    ...
    harvestThreshold: 0.05, energyConserve: 0.8, explorationDrive: 0.08,
  ...
  // INSIGHT: merge efficiency with beauty. Moderate threshold, high trail intensity.
  {
    ...
    harvestThreshold: 0.12, energyConserve: 0.65, explorationDrive: 0.25,
