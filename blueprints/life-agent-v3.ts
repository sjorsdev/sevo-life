// life-agent-v3.ts — Parameter-evolved from v2: Efficiency demands restraint in movement; beauty demands temporal regularity. De
...
const genomes: EntityGenome[] = [
  ...
  // INSIGHT: reduced harvestThreshold from 0.1 to 0.05 to capture more marginal resources
  {
    ...
    harvestThreshold: 0.04, energyConserve: 0.85, explorationDrive: 0.15,
  ...
  // INSIGHT: shifted from 0.2 to 0.15 harvestThreshold for better efficiency baseline
  {
    ...
    trailIntensity: 0.5, trailColor: 3, pulseFrequency: 0.2, patternSymmetry: 0.6,
  },
