// life-agent-v3.ts — Parameter-evolved from v2: Less movement, more painting: reduce moveSpeed by 10-15%, boost energyConserve 5
...
const genomes: EntityGenome[] = [
  ...
  // INSIGHT: new role focused purely on efficiency. Low threshold + high attraction.
  {
    ...
    harvestThreshold: 0.08, energyConserve: 0.5, explorationDrive: 0.7,
    trailIntensity: 0.5, trailColor: 0, pulseFrequency: 0.15, patternSymmetry: 0.2,
  },
  ...
  // INSIGHT: reduced harvestThreshold from 0.1 to 0.05 to capture more marginal resources
  {
    ...
    trailIntensity: 0.35, trailColor: 1, pulseFrequency: 0.1, patternSymmetry: 0.4,
  },
  ...
  // INSIGHT: merge efficiency with beauty. Moderate threshold, high trail intensity.
  {
    ...
    trailIntensity: 0.85, trailColor: 2, pulseFrequency: 0.4, patternSymmetry: 0.75,
  },
  ...
  {
    moveSpeed: 0.55, turnBias: 0.05, resourceAttraction: 0.65, trailAttraction: 0.1,
    harvestThreshold: 0.15, energyConserve: 0.55, explorationDrive: 0.5,
    trailIntensity: 0.65, trailColor: 3, pulseFrequency: 0.25, patternSymmetry: 0.5,
  },
  ...
  {
    moveSpeed: 0.6, turnBias: -0.2, resourceAttraction: 0.88, trailAttraction: -0.3,
    harvestThreshold: 0.1, energyConserve: 0.75, explorationDrive: 0.8,
    trailIntensity: 0.15, trailColor: 4, pulseFrequency: 0.35, patternSymmetry: 0.1,
  },
