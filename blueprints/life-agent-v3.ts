// life-agent-v3.ts — Parameter-evolved from v2: Efficiency collapses when entities are harvest-conservative + sedentary; aggress
...
const genomes: EntityGenome[] = [
  ...
  // INSIGHT: new role focused purely on efficiency. Low threshold + high attraction.
  {
    ...
    harvestThreshold: 0.06, energyConserve: 0.4, explorationDrive: 0.7,
  ...
  // INSIGHT: merge efficiency with beauty. Moderate threshold, high trail intensity.
  {
    ...
    harvestThreshold: 0.11, energyConserve: 0.45, explorationDrive: 0.55,
    trailIntensity: 0.85, trailColor: 2, pulseFrequency: 0.35, patternSymmetry: 0.75,
  },
  ...
  // INSIGHT: reduced energy waste (lower moveSpeed for endurance) while maintaining resource drive
  {
    ...
    harvestThreshold: 0.09, energyConserve: 0.65, explorationDrive: 0.8,
