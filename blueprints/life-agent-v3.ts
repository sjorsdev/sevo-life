// life-agent-v3.ts — Parameter-evolved from v2: High moveSpeed + low energyConserve = efficient-looking agents that hemorrhage e
...
const genomes: EntityGenome[] = [
  ...
  // INSIGHT: reduced harvestThreshold from 0.1 to 0.05 to capture more marginal resources
  {
    ...
    harvestThreshold: 0.03, energyConserve: 0.8, explorationDrive: 0.15,
  ...
  // INSIGHT: reduced energy waste (lower moveSpeed for endurance) while maintaining resource drive
  {
    ...
    harvestThreshold: 0.08, energyConserve: 0.75, explorationDrive: 0.8,
