// life-agent-v3.ts — Parameter-evolved from v2: Efficiency scales with (energyConserve × inverse_harvestThreshold) / moveSpeed —
...
const genomes: EntityGenome[] = [
  ...
  // INSIGHT: new role focused purely on efficiency. Low threshold + high attraction.
  {
    ...
    harvestThreshold: 0.05, energyConserve: 0.55, explorationDrive: 0.7,
  ...
  // INSIGHT: merge efficiency with beauty. Moderate threshold, high trail intensity.
  {
    ...
    harvestThreshold: 0.08, energyConserve: 0.55, explorationDrive: 0.55,
  ...
  {
    moveSpeed: 0.7, turnBias: -0.2, resourceAttraction: 0.88, trailAttraction: -0.3,
    harvestThreshold: 0.06, energyConserve: 0.72, explorationDrive: 0.8,
